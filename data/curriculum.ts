...
const ALL_LEVELS: LevelData[] = [
  ...
  {
    id: 'un', letter: 'un', pinyin: 'wēn', type: 'nasal-final', tone: 1,
    example: '温', word: '温暖',
    mouthGuide: '从 u 滑向 n，嘴唇从圆缩变平，舌尖顶上牙床，声音从鼻子出来',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '温', quizWrong: ['翁', '分', '文'],
    audioKey: 'un', stageIndex: 14,
  },
  {
    id: 'vn', letter: 'ün', pinyin: 'yūn', type: 'nasal-final', tone: 1,
    example: '晕', word: '晕车',
    mouthGuide: '从 ü 滑向 n，嘴唇从翘起圆唇变平，舌尖顶上牙床',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '晕', quizWrong: ['云', '英', '韵'],
    audioKey: 'vn', stageIndex: 15,
  },
  {
    id: 'ing', letter: 'ing', pinyin: 'yīng', type: 'nasal-final', tone: 1,
    example: '英', word: '英明',
    mouthGuide: '从 i 滑向 ng，保持微笑嘴型，舌根抬高，用鼻子哼出来',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '英', quizWrong: ['因', '应', '音'],
    audioKey: 'ing', stageIndex: 16,
  },
  {
    id: 'ong', letter: 'ong', pinyin: 'ōng', type: 'nasal-final', tone: 1,
    example: '轰', word: '轰隆',
    mouthGuide: '嘴巴圆圆，舌根抬高堵住气流，声音从鼻子出来',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '轰', quizWrong: ['哼', '昂', '空'],
    audioKey: 'ong', stageIndex: 17,
  },
  ...
  {
    id: 'yue', letter: 'yue', pinyin: 'yuē', type: 'whole-syllable', tone: 1,
    example: '约', word: '约定',
    mouthGuide: '直接读"约"，不用拼，一口读出',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '约', quizWrong: ['月', '夜', '乐'],
    audioKey: 'yue', stageIndex: 11,
  },
  {
    id: 'yuan', letter: 'yuan', pinyin: 'yuān', type: 'whole-syllable', tone: 1,
    example: '冤', word: '冤枉',
    mouthGuide: '直接读"冤"，不用拼，一口读出',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '冤', quizWrong: ['圆', '远', '院'],
    audioKey: 'yuan', stageIndex: 12,
  },
  {
    id: 'yin', letter: 'yin', pinyin: 'yīn', type: 'whole-syllable', tone: 1,
    example: '因', word: '因为',
    mouthGuide: '直接读"因"，不用拼，一口读出',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '因', quizWrong: ['音', '印', '英'],
    audioKey: 'yin', stageIndex: 13,
  },
  {
    id: 'yun', letter: 'yun', pinyin: 'yūn', type: 'whole-syllable', tone: 1,
    example: '晕', word: '晕倒',
    mouthGuide: '直接读"晕"，不用拼，一口读出',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '晕', quizWrong: ['云', '运', '军'],
    audioKey: 'yun', stageIndex: 14,
  },
  {
    id: 'ying', letter: 'ying', pinyin: 'yīng', type: 'whole-syllable', tone: 1,
    example: '鹰', word: '老鹰',
    mouthGuide: '直接读"鹰"，不用拼，一口读出',
    toneRhyme: '一声高高平又平',
    toneGesture: '右手平伸，从胸前平稳滑向右侧',
    quizCorrect: '鹰', quizWrong: ['英', '应', '影'],
    audioKey: 'ying', stageIndex: 15,
  },
];
